...
public class SaleController {
    ...
    // Endpoint untuk mengambil semua penjualan
    @GetMapping
    public ResponseEntity<List<SaleDetailsResponse>> getAllSales() {
        List<SaleDetailsResponse> sales = saleService.getAllSales().stream()
                .map(SaleDetailsResponse::new)
